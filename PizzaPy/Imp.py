...
Fordítsatok figyelmet valamilyen rendezetteb adatkiírásra,
adatmegjelenítésre, adatbekérésre. lehet ez már komplexebb, mint egy szimpla input.."""
...
nagysag=["", "kicsi", "normal", "nagy"]
#Rendelésfelvétel
def rendelesfelvi():
    print("Add meg, milyen pizzát szeretnél! ")
    tovabb=input("Akarsz új rendelést felvenni? i/n : ")
    while (tovabb=='i'):
